...
trussStruct=struct();
% trussMembers contains the x and y start coordnate, and x and y stop
% coordnate of each member. 
trussStruct.trussMembers=[];
% trussSupports contains the x and y coordinate of the pin and roller,
% respectively
trussStruct.trussSupports=[];
% trussLoads contains x and y coordinates of each loading points, as well
% as the x and y magnitude of the loading
trussStruct.trussLoads=[];
% trussForces contains x matrix of unknowns in Ax=B equation
trussStruct.trussForces=[];

prompt = {'Horizontal Spacing Interval [ft or m]: ',...
    'Number of Horizontal Spaces: ',...
    'Vertical Spacing Interval [ft or m]: ',...
